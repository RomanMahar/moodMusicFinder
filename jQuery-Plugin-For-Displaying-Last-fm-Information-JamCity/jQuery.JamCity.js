 ...
 */ (function ($) {
  ...
  $.fn.JamCity = function (options) {
    ...
    // Default JMC Options
    var defaults = {
      apiKey: 'b06eb5bc5f6fa61870aad8fbae8cf2ae', // Your Last.fm API key. You can get this easily setup here: http://www.last.fm/api/account.
      ...
      number: 10, // Number of tracks to display. Defaults to 5.
